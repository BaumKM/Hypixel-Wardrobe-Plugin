...
public class convert_wardrobe_array {
     ...
     * --> Json String is can be stored in a database <br>
     * <br>
    ...
    public static String ArrayToString(Object[] arr){
        ...
        System.out.println(JsonString.ArrayToJsonString(s).length());
        return JsonString.ArrayToJsonString(s);
    }
     ...
     * @return Object[]
     */
    public static Object[] StringToArray(String b){
        String[] s = JsonString.JsonStringToArray(b);
